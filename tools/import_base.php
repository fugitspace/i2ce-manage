...
class CSVDataFile extends DataFile {
    ...
    public function getHeaders() {
        ...
        foreach (array("\t",",",";") as $sep) {
            ...
            if ( $headers === FALSE|| count($headers) < 2 || !simple_prompt("Do these look like the correct first row?\n". print_r($headers,true))) {
                fseek($this->fp,0);
                continue;
            }
